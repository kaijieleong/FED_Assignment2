...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const APIKEY = "659e2ac33f71b00c7d0a98ea";
  getContacts();
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      fetch("https://interactivedev-cfa7.restdb.io/rest/contact", settings)
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    fetch(`https://interactivedev-cfa7.restdb.io/rest/contact/${id}`, settings)
      .then((response) => response.json())
      .then((data) => {
        console.log(data);
        document.getElementById("update-contact-container").style.display =
